...
CREATE TABLE `tbl_comments` (
  ...
  `comment_username` varchar(25) NOT NULL,
...
(18, 'TH_Kick_Ass.jpg', 'Kick_Ass.jpg', 'nobImg.jpg', 'Kick-Ass', '2010', 'Dave Lizewski is an unnoticed high school student and comic book fan with a few friends and who lives alone with his father. His life is not very difficult and his personal trials not that overwhelming. However, one day he makes the simple decision to become a super-hero even though he has no powers or training', '117 min', 'kickass.mp4', '26.99'),
